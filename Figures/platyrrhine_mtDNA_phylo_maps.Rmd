...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Cebinae$V14)), option = "plasma", end = 0.85)
x.lvl <- unique(Cebinae$V14)
cols<-setNames(y[match(Cebinae$V14, x.lvl)], Cebinae$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Alouatta$V14)), option = "plasma")
x.lvl <- unique(Alouatta$V14)
cols<-setNames(y[match(Alouatta$V14, x.lvl)], Alouatta$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Saimiri$V14)), option = "plasma")
x.lvl <- unique(Saimiri$V14)
cols<-setNames(y[match(Saimiri$V14, x.lvl)], Saimiri$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Cheracebus$V14)), option = "plasma")
x.lvl <- unique(Cheracebus$V14)
cols<-setNames(y[match(Cheracebus$V14, x.lvl)], Cheracebus$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Plecturocebus$V14)), option = "plasma")
x.lvl <- unique(Plecturocebus$V14)
cols<-setNames(y[match(Plecturocebus$V14, x.lvl)], Plecturocebus$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Cacajao$V14)), option = "plasma")
x.lvl <- unique(Cacajao$V14)
cols<-setNames(y[match(Cacajao$V14, x.lvl)], Cacajao$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Pithecia$V14)), option = "plasma")
x.lvl <- unique(Pithecia$V14)
cols<-setNames(y[match(Pithecia$V14, x.lvl)], Pithecia$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Ateles$V14)), option = "plasma")
x.lvl <- unique(Ateles$V14)
cols<-setNames(y[match(Ateles$V14, x.lvl)], Ateles$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Chiropotes$V14)), option = "plasma")
x.lvl <- unique(Chiropotes$V14)
cols<-setNames(y[match(Chiropotes$V14, x.lvl)], Chiropotes$V12)
```
...
Set colors based on mPTP species assignment
```{r}
y = viridis(n=length(unique(Callitrichidae$V14)), option = "plasma")
x.lvl <- unique(Callitrichidae$V14)
cols<-setNames(y[match(Callitrichidae$V14, x.lvl)], Callitrichidae$V12)
```
